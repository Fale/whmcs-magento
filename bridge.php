<?php
$url = "http://dev.whmcs.snds.co/includes/api.php"; # URL to WHMCS API file goes here
$username = "fale"; # Admin username goes here
$password = "c00f9dbd"; # Admin password goes here
